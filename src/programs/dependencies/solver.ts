import { NS } from '@ns';
export async function main(ns: { args: any[]; }) {
	solveContract(ns, ns.args[0], ns.args[1], 1);
}

export function solveContract(ns: { codingcontract: { getContractType: (arg0: any, arg1: any) => any; getDescription: (arg0: any, arg1: any) => any; getData: (arg0: any, arg1: any) => any; attempt: (arg0: any, arg1: any, arg2: any, arg3: {}) => any; }; }, host: string, filename: string, logLevel=0) {
